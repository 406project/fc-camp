...
// }]);
},{"./app/Controllers/DetailsController":2,"./app/Controllers/ListController":3,"./app/jQuery/scrolledPanel":4,"angular":5,"jquery":6,"modernizr":7}],2:[function(require,module,exports){
// DetailsController 정의 및 연결
angular.module('AppControllers')
.controller('DetailsController', ['$scope', function($scope) {
	// DetailsController $scope 속성/메소드 정의
}]);
