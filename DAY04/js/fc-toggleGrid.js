...
(function(global, DOM){
	...
	// console.log( toggle_grid_btn.outerHTML );

	// 문서에 추가
	// parentElement.appendChild(childElement)
	// childElement.parentNode.appendChild(childElement)
	// document.body.appendChild(toggle_grid_btn);

	var btn_code = toggle_grid_btn.outerHTML;
	...
	// document.body.insertAdjacentHTML('afterend', btn_code);
	console.log(DOM.prepend(container, btn_code));

	// DOM.prepend(부모, 자식) | DOM.prependTo(자식, 부모)
	// DOM.append()
	// DOM.before()
	// DOM.after()
