...
- [단일 `var` 패턴 (Var Singleton Pattern)](#%EB%8B%A8%EC%9D%BC-var-%ED%8C%A8%ED%84%B4-var-singleton-pattern)
...
전역 변수 사용을 최소화한다는 것은 **전역을 오염시키지 않는 것**을 말한다.<br>
...
#### 단일 `var` 패턴 (Var Singleton Pattern)
