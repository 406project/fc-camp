...
- AngularJS
	- 모듈/컨트롤러 정의: Module / Controller
	- 뷰/컨트롤러를 연결하는 스코프: Scope
	- 사용자 피드백: User Feedback
	- 대소문자 구별 검색: sesitiveSearch
	- 의존성 모듈 압축 시 보호하는 방법: Protect Dependency Injection Keyword
